...
struct OnboardingMascotLottieView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> LottieAnimationView {
        ...
        animationView.animation = OnboardingMascotLottieCache.animation(for: animation)
...
@MainActor
enum OnboardingMascotLottieCache {
